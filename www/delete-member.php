                        ...
                        <div class="graph-form">
                            <div class="form-body">
                                <form method="post">
                                    ...
                                    if ($member) { ?>
                                        <h2 class="inner-tittle">Etes vous certain de vouloir supprimer le membre <?php  echo $member->FirstName . " " . $member->LastName;?> ?</h2>
                                        <button type="submit" class="btn btn-default" name="submit" id="submit">Supprimer</button>
                                    <?php  } ?>
