<div class="sidebar-menu">
    ...
    <div class="down">
        <?php
        $aid = $_SESSION['userId'];
        $sql = "SELECT FirstName, LastName from myclub_admin where ID=:aid";
        ...
        if ($query->rowCount() > 0) {
            foreach ($results as $row) { ?>
                ...
                <a href="dashboard.php"><span class=" name-caret"><?php echo $row->FirstName . ' ' . $row->LastName; ?></span></a>
    ...
    <div class="menu">
        <ul id="menu">
            ...
            <li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span> Services</span> <span
